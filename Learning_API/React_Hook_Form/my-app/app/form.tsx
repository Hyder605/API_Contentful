...
//     // Destructuring
//     const {
//         register, //track the changes for input field.to keep track of its value, validation rules, errors, and other properties that are important for form submission
//         handleSubmit, //is s function , called when the form is submitted
//         formState:{errors},
//     }=useForm();
//     // or
//     //  const a=useForm();
...
//             {/* //To show the error */}
//                 {errors.password && errors.password.type==='required'&&(<p className='border p-3'>Password is required</p>)}
...
const Form = () => {
    ...
    return (
        <div className="mx-10 my-10">
            ...
            <form className="flex gap-y-4 flex-col bg-gray-200 max-w-lg rounded-lg p-6 lg:p-8 mx-auto mt-6"
                ...
                {/* Success message */}
                {isLoggedIn && <p className='text-green-600 text-center'>You're now logged in.</p>}
            </form>
        </div>
    )
}
